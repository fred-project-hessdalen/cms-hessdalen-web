...
export default function SiteNavigation() {
    return (
        <Suspense
            fallback={
                <div className="relative bg-gray-50 dark:bg-gray-800 px-4 py-1">
                    <nav className="flex justify-center items-center gap-4">
                        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium tracking-wide py-2 px-3">
                            Loading navigation...
                        </div>
                    </nav>
                </div>
